...
// **************************************
    try {
        ...
        if ( sizeof($res) > 0 ){
            ...
            echo "Empiezan mensajes...";
            //-- conectamos con MessageBird
            //$api = new \MessageBird\Client('live_Mj9aGJr8MTaKEKvjnVVIAAhIA');
            $api = new \MessageBird\Client('Mj9aGJr8MTaKEKvjnVVIAAhIA');
            //$api = new \MessageBird\Client('aAYdOHVUmIE6XKCgqcDNEfoW0');

            $Balance = $api->balance->read();
            ...
            //$destino = $devuelvo['data']['data'][0];
                ...
                if ( $id == 1 || $id == 2 || $id == 6 ){
                    ...
                    if ( $id == 1 || $id == 2 ) $clinica = "Clinica Dental Eneresi. ";
                    ...
                    $confirma = ". Confirma-la responent Si o No a aquest SMS. Grácies.";
                } else {
                    //-- CASTELLA
                    //-- para poder poner en castellano/catalan? la fecha de la cita
                ...
                if ( $test == 0 ) {
                    if (  $to != "" && strlen($to) == 11 && $to[2] != '9' ) {
                        ...
                        echo $to . "\n";
                        //$text = "Probando el envio desde MessageBird";

                        $Message = new \MessageBird\Objects\Message();
                        $Message->originator = 'Eneresi';
                        ...
                        $response = $api->messages->create($Message);
                        print_r($response);
